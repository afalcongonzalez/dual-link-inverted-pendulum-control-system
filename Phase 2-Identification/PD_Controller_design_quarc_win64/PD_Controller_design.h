 ...
 */
#ifndef RTW_HEADER_PD_Controller_design_h_
#define RTW_HEADER_PD_Controller_design_h_
#ifndef PD_Controller_design_COMMON_INCLUDES_
# define PD_Controller_design_COMMON_INCLUDES_
#include <math.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* PD_Controller_design_COMMON_INCLUDES_ */

#include "PD_Controller_design_types.h"
...
#define PD_Controller_design_rtModel   RT_MODEL_PD_Controller_design

/* Block signals (auto storage) */
typedef struct {
  real_T HILReadTimebase[3];           /* '<S4>/HIL Read Timebase' */
  ...
  real_T Sum1;                         /* '<S2>/Sum1' */
  real_T Add[2];                       /* '<S3>/Add' */
  real_T Switch_a[2];                  /* '<S3>/Switch' */
  real_T K1[2];                        /* '<S3>/K1' */
  real_T gaint1for2dPantonew;          /* '<S4>/gain t1 for 2dPanto new' */
  real_T gaint1for2dPanto;             /* '<S4>/gain t1 for 2dPanto' */
  real_T gainfor2DPantonewamplifier[2];/* '<S3>/gain for 2DPanto new amplifier' */
  real_T gainfor2DPantoamplifier[2];   /* '<S3>/gain for 2DPanto amplifier' */
} BlockIO_PD_Controller_design;
...
typedef struct {
  ...
  t_task HILReadTimebase_Task;         /* '<S4>/HIL Read Timebase' */
  struct {
    real_T TimeStampA;
    real_T LastUAtTimeA;
    real_T TimeStampB;
  ...
  int32_T HILReadTimebase_EncoderBuffer[3];/* '<S4>/HIL Read Timebase' */
  boolean_T HILInitialize_DOBits[4];   /* '<Root>/HIL Initialize' */
  t_boolean HILWriteDigital_Buffer[4]; /* '<S3>/HIL Write Digital' */
} D_Work_PD_Controller_design;

/* Backward compatible GRT Identifiers */
#define rtB                            PD_Controller_design_B
#define BlockIO                        BlockIO_PD_Controller_design
#define rtXdot                         PD_Controller_design_Xdot
#define StateDerivatives               StateDerivatives_PD_Controller_
#define tXdis                          PD_Controller_design_Xdis
#define StateDisabled                  StateDisabled_PD_Controller_des
#define rtP                            PD_Controller_design_P
#define Parameters                     Parameters_PD_Controller_design
#define rtDWork                        PD_Controller_design_DWork
#define D_Work                         D_Work_PD_Controller_design

/* Parameters (auto storage) */
struct Parameters_PD_Controller_design_ {
  ...
  real_T Constant2_Value;              /* Expression: pi/2
                                        ...
                                        */
  real_T SineWave2_Amp;                /* Expression: 60*(pi/180)
                                        * Referenced by: '<Root>/Sine Wave2'
                                        */
  real_T SineWave2_Bias;               /* Expression: pi/2
                                        * Referenced by: '<Root>/Sine Wave2'
                                        */
  real_T SineWave2_Freq;               /* Expression: (1/3)*(2*pi)
                                        * Referenced by: '<Root>/Sine Wave2'
                                        */
  ...
  real_T Constant_Value;               /* Expression: 10
                                        ...
                                        */
  real_T Gain_Gain;                    /* Expression: 1500
                                        * Referenced by: '<S2>/Gain'
                                        */
  real_T Gain1_Gain;                   /* Expression: 100
                                        * Referenced by: '<S2>/Gain1'
                                        */
  real_T Constant1_Value_e;            /* Expression: NewPanto
  ...
  real_T K1_Gain[2];                   /* Expression: [1 1]
                                        * Referenced by: '<S3>/K1'
                                        */
  real_T Constant_Value_a[4];          /* Expression: [1 1 1 1]
...
struct RT_MODEL_PD_Controller_design {
  const char_T *path;
...
extern Parameters_PD_Controller_design PD_Controller_design_P;

/* Block signals (auto storage) */
extern BlockIO_PD_Controller_design PD_Controller_design_B;

/* Block states (auto storage) */
extern D_Work_PD_Controller_design PD_Controller_design_DWork;

/* Model entry point functions */
extern void PD_Controller_design_initialize(boolean_T firstTime);
extern void PD_Controller_design_output(int_T tid);
extern void PD_Controller_design_update(int_T tid);
extern void PD_Controller_design_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_PD_Controller_design *const PD_Controller_design_M;
 ...
 * Block '<S4>/gain t1 for 2dPanto new1' : Unused code path elimination
 */
 ...
 *
 * '<Root>' : 'PD_Controller_design'
 * '<S1>'   : 'PD_Controller_design/Robot'
 * '<S2>'   : 'PD_Controller_design/controller'
 * '<S3>'   : 'PD_Controller_design/Robot/2Dpanto motor'
 * '<S4>'   : 'PD_Controller_design/Robot/Encoders'
 * '<S5>'   : 'PD_Controller_design/Robot/2Dpanto motor/Haptic 3-DOF Pantograph Enable'
 */
#endif                                 /* RTW_HEADER_PD_Controller_design_h_ */
